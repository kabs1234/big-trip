...
const createTripEventSortsTemplate = (activeSorting) => (`
  <form class="trip-events__trip-sort  trip-sort" action="#" method="get">
    <div class="trip-sort__item  trip-sort__item--day">
      <input id="sort-day" class="trip-sort__input visually-hidden" type="radio" name="trip-sort" value="sort-day" ${activeSorting === SORT_TYPE.DAY ? 'checked' : ''}>
    ...
    <div class="trip-sort__item  trip-sort__item--time">
      <input id="sort-time" class="trip-sort__input visually-hidden" type="radio" name="trip-sort" value="sort-time" ${activeSorting === SORT_TYPE.TIME ? 'checked' : ''}>
      <label class="trip-sort__btn" for="sort-time">Time</label>
    </div>

    <div class="trip-sort__item  trip-sort__item--price">
      <input id="sort-price" class="trip-sort__input visually-hidden" type="radio" name="trip-sort" value="sort-price" ${activeSorting === SORT_TYPE.PRICE ? 'checked' : ''}>
...
export default class TripEventSortsView extends AbstractView {
  ...
  get template() {
    return createTripEventSortsTemplate(this.#activeSorting);
  }
}
