...
const tripInfoPresenter = new TripInfoPresenter(tripEventsModel, tripOffersModel, tripHeaderContainer.element);
const tripFiltersPresenter = new TripFiltersPresenter(tripEventsModel, tripOffersModel, tripHeaderContainer.element);
